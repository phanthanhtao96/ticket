const imgUrl = 'https://tk.saobacdautelecom.vn';
(function ($) {
        ...
        if (settings.imageHTML
            ...
            $imageForm.append(
                $formItem.clone()
                    ...
                    .append($formLabel.clone().html('<button type="button" style="width: 100%" onclick="makeSelection(this.form,\'imageURL\',null)">Select</button>'))
            );
            /*
            $imageForm.append(
                $formItem.clone()
        ...
        $(document).on("click", "#richText-Image button.btn", function (event) {
            ...
            if ($form.attr("data-editor") === editorID) {
                ...
                if (!url) {
                    ...
                    if (settings.useSingleQuotes === true) {
                        if (align === "center") {
                            html = "<div style='text-align:center;'><img src='" + imgUrl + '/uploads/1200/' + url + "'></div>";
                        } else {
                            html = "<img src='" + imgUrl + '/uploads/1200/' + url + "' align='" + align + "'>";
                        }
                    } else {
                        if (align === "center") {
                            html = '<div style="text-align:center;"><img src="' + imgUrl + '/uploads/1200/' + url + '"></div>';
